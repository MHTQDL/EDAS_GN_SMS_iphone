...
//    printf("Receive 接收 ");
    ...
    //接收
    ret=m_trfobj->Receive((int *)m_rcv_buffer);//读取 解码
    if(ret==-1)
    {
        printf("ret==-1");
        //reconnect
...
//    }
    ...
    if(pchn==NULL || pblk==NULL){
        printf("pchn==NULL || pblk==NULL");
        return FALSE;
    }
    
    if(p1[1]!=0x55CC && p1[1]!=0x55BB && p1[1]!=0x55AA && p1[1]!=0x5555 && p1[1]!=0x55DD && p1[1]!=0x5501 &&  p1[1]!=0x5502 && p1[1]!=0x55dd)
    {
